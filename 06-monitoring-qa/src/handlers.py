    ...
    try:
        ...
        if rag.vector_store:
            ...
            await message.answer(
                ...
                "Проверьте настройки эмбеддингов и доступ к API:\n"
                "• OPENAI_API_KEY\n"
                "• OPENAI_BASE_URL (например, https://openrouter.ai/api/v1 или https://api.openai.com/v1)\n"
                "• EMBEDDING_MODEL (должна поддерживаться выбранным провайдером)\n\n"
                "Также убедитесь, что в папке data есть PDF и sberbank_help_documents.json."
            )
