...
│   ├── agent.py                # Создание ReAct агента с MCP инструментами
...
3. **agent.py** - ReAct агент с MCP интеграцией
   ...
   - Агент самостоятельно принимает решения о вызове нужного инструмента
...
**Поток данных (ReAct Agent с MCP):**
```
